...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.normalize=void 0;var _path=__webpack_require__(3);Object.defineProperty(exports,'normalize',{enumerable:!0,get:function get(){return _path.normalize}}),exports.hmac=hmac,exports.hash=hash;var _crypto=__webpack_require__(2);const algorithm='sha256';function hmac(a,b){let c=2<arguments.length&&arguments[2]!==void 0?arguments[2]:'binary';return Promise.resolve((0,_crypto.createHmac)(algorithm,a).update(b).digest(c))}function hash(a){return Promise.resolve((0,_crypto.createHash)(algorithm).update(a).digest('hex'))}
