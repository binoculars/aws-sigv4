...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.hmac=hmac,exports.hash=hash;const crypto=window.crypto||window.msCrypto,subtle=crypto.subtle||crypto.webkitSubtle,algorithm='sha-256',normalize=exports.normalize=encodeURI;function toHex(a){const b=new Uint8Array(a);let c='';for(let d=0;d<b.length;++d){const e=b[d].toString(16);c+=`${2>e.length?'0':''}${e}`}return c}const toBinary='TextEncoder'in window?(a)=>new TextEncoder().encode(a):(a)=>{const b=a.length,c=new ArrayBuffer(2*b),d=new Uint16Array(c);for(let e=0;e<b;e++)d[e]=a.charCodeAt(e);return c},hashOptions={name:algorithm},algorithmSign={name:'HMAC',hash:hashOptions};function hmac(a,b){let c=2<arguments.length&&arguments[2]!==void 0?arguments[2]:'binary';return subtle.importKey('raw','string'==typeof a?toBinary(a):a,algorithmSign,!1,['sign']).then((d)=>subtle.sign(algorithmSign,d,toBinary(b))).then((d)=>'binary'===c?d:toHex(d))}function hash(a){return subtle.digest(hashOptions,toBinary(a)).then(toHex)}
